...
contract NFTMinecraft is ERC721URIStorage, Ownable {
    ...
    constructor()
        ERC721("MIRECOS MINECRAFT NFT", "MRMCNFT")
        Ownable(msg.sender)
    {
        // Mint 5 NFTs to the initial owner
        for (uint256 i = 0; i < 10; i++) {
            uint256 tokenId = _nextTokenId++;
            string memory tokenUR = string(abi.encodePacked("https://web-production-8414.up.railway.app/minecraft/", Strings.toString(tokenId)));
